 ...
 */
final class Version20230613131439 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add capacity to availability';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE availability ADD COLUMN capacity INTEGER DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__availability AS SELECT id, restaurant_id, teacher_id, language_id, status_id, start, duration, price, comment, created_at, updated_at, deleted_at, is_enabled FROM availability');
        ...
        $this->addSql('INSERT INTO availability (id, restaurant_id, teacher_id, language_id, status_id, start, duration, price, comment, created_at, updated_at, deleted_at, is_enabled) SELECT id, restaurant_id, teacher_id, language_id, status_id, start, duration, price, comment, created_at, updated_at, deleted_at, is_enabled FROM __temp__availability');
