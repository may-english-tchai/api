...
final class Version20230605171327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , price DOUBLE PRECISION NOT NULL, comment CLOB DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, is_enabled BOOLEAN DEFAULT 1 NOT NULL, duration INTEGER NOT NULL DEFAULT 60, PRIMARY KEY(id), CONSTRAINT FK_3FB7A2BFB1E7706E FOREIGN KEY (restaurant_id) REFERENCES restaurant (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3FB7A2BF41807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3FB7A2BF82F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3FB7A2BF6BF700BD FOREIGN KEY (status_id) REFERENCES availability_status (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
